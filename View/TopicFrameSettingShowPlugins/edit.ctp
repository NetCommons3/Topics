...
<?php echo $this->Form->create('TopicFrameSettingShowPlugin'); ?>
	<fieldset>
		<legend><?php echo __('Edit Topic Frame Setting Show Plugin'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TopicFrameSettingShowPlugin.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TopicFrameSettingShowPlugin.id'))); ?></li>
